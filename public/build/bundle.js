...
var app = (function () {
    ...
    function add_css(target) {
    	append_styles(target, "svelte-doime6", "#container.svelte-doime6{display:grid;grid-template-rows:auto 1fr;grid-template-columns:auto 1fr;gap:1rem 1rem;background-color:var(--palette-color-2);width:80%;margin:0 10% 8rem 10%;border-radius:3rem;opacity:0%;transform:translateX(-10rem);transition:0.75s;box-shadow:0 1.5rem 1rem #000000c0;border-style:outset;border-radius:3rem;border-width:.5rem;border-color:var(--palette-color-4);font-size:100%;padding:1rem;overflow:hidden}#header.svelte-doime6{grid-row-start:1;grid-row-end:2;grid-column-start:2;grid-column-end:3;min-width:100%;height:fit-content;overflow:hidden;font-family:\"Secular One\";text-align:left;font-size:500%;margin:0;padding:0 0 0 1rem;color:var(--palette-color-1);font-weight:lighter}#image_area.svelte-doime6{grid-row-start:1;grid-row-end:3;grid-column-start:1;grid-column-end:2;margin:auto}#text_area.svelte-doime6{grid-row-start:2;grid-row-end:3;grid-column-start:2;grid-column-end:3;font-family:\"Rubik\";height:fit-content;max-height:fit-content;text-align:left;width:100%;font-size:2.4rem;color:var(--palette-color-1);line-height:3.25rem;vertical-align:top;margin:0;padding:0rem 1rem}");
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h1, "class", "svelte-doime6");
    			attr(div0, "id", "image_area");
    			attr(div0, "class", "svelte-doime6");
    			attr(div1, "id", "text_area");
    			attr(div1, "class", "svelte-doime6");
    			attr(div2, "id", "container");
    			attr(div2, "class", "svelte-doime6");
    		},
    		m(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let resizeCard = function () {
    		...
    		$$invalidate(5, image_area.style.maxWidth = new_size.toString() + 'px', image_area);
    	};
    	...
    	onMount(async () => {
    		...
    		paths_list.forEach(element => {
    			...
    			$$invalidate(3, container.style.background_color = "blue", container);

    			$$invalidate(3, container.style.gap = "0 1rem", container);
