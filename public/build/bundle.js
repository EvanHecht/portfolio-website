...
var app = (function () {
    ...
    function add_css$5(target) {
    	append_styles(target, "svelte-1w176sp", "@keyframes svelte-1w176sp-appear-from-top{from{opacity:0%;transform:translateY(-10rem)}to{opacity:100%;transform:translateY(0rem)}}@keyframes svelte-1w176sp-appear-from-bottom{from{opacity:0%;transform:translateY(10rem)}to{opacity:100%;transform:translateY(0rem)}}@keyframes svelte-1w176sp-arrow-animation{0%{opacity:0%}10%{opacity:100%;transform:translateY(0rem)}20%{opacity:100%;transform:translateY(2rem)}30%{transform:translateY(0rem);opacity:100%\r\n        }40%{transform:translateY(2rem);opacity:100%\r\n        }50%{transform:translateY(0rem);opacity:100%\r\n        }60%{transform:translateY(2rem);opacity:100%\r\n        }70%{transform:translateY(0rem);opacity:100%\r\n        }80%{transform:translateY(2rem);opacity:100%\r\n        }90%{transform:translateY(0rem);opacity:100%\r\n        }100%{transform:translateY(2rem);opacity:0%\r\n        }}h1.svelte-1w176sp{text-align:center;color:silver;font-family:\"Rubik\";font-weight:1;font-size:80px;margin:8rem 0 0 0;opacity:0;animation:svelte-1w176sp-appear-from-top 1s .5s forwards}h2.svelte-1w176sp{text-align:center;color:grey;font-family:\"Rubik\";font-weight:1;font-size:40px;margin:0 0 2rem;opacity:0;animation:svelte-1w176sp-appear-from-bottom 1s 1.5s forwards}#arrow.svelte-1w176sp{width:3%;image-rendering:crisp-edges;margin:3rem 48.5%;opacity:0;animation:svelte-1w176sp-arrow-animation 5s 2.5s forwards}");
    }
    ...
    function add_css$4(target) {
    	append_styles(target, "svelte-qo7pow", "#container.svelte-qo7pow{display:grid;grid-template-rows:auto auto;grid-template-columns:fit-content(25%) fit-content(75%);background-color:var(--palette-color-3);gap:1rem;padding:1rem;width:80%;margin:0 10% 8rem 10%;border-radius:3rem;opacity:0%;transform:translateX(-10rem);transition:0.75s;box-shadow:0 1.5rem 1rem #000000c0;border-style:outset;border-radius:3rem;border-width:.5rem;border-color:var(--palette-color-4);font-size:100%;overflow:hidden}#header.svelte-qo7pow{grid-row-start:1;grid-row-end:2;grid-column-start:2;grid-column-end:3;min-width:100%;height:100%;overflow:hidden;font-family:\"Secular One\";text-align:center;font-size:500%;margin:0;color:var(--palette-color-2);font-weight:lighter}#image_area.svelte-qo7pow{grid-row-start:1;grid-row-end:3;grid-column-start:1;grid-column-end:2;width:100%;margin:auto}#text_area.svelte-qo7pow{grid-row-start:2;grid-row-end:3;grid-column-start:2;grid-column-end:3;font-family:\"Rubik\";text-align:left;width:100%;font-size:2.4rem;color:var(--palette-color-2);line-height:3.25rem;margin:0;vertical-align:top}");
    }
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h1, "class", "svelte-qo7pow");
    			attr(div0, "id", "image_area");
    			attr(div0, "class", "svelte-qo7pow");
    			attr(div1, "id", "text_area");
    			attr(div1, "class", "svelte-qo7pow");
    			attr(div2, "id", "container");
    			attr(div2, "class", "svelte-qo7pow");
    		},
    		m(target, anchor) {
    ...
    function add_css$3(target) {
    	append_styles(target, "svelte-1fakwj9", "@keyframes svelte-1fakwj9-intro_animation{0%{opacity:0%;transform:translateY(10rem)}100%{opacity:100%;transform:translateY(0rem)}}#Container.svelte-1fakwj9{background-color:var(--palette-color-3);height:fit-content;max-height:55rem;margin:0;display:grid;grid-template-columns:auto;grid-template-rows:1fr 2fr 2fr 1fr;border-radius:3rem 3rem;padding:2.5%;box-shadow:0 1.5rem 1rem;border-style:outset;border-radius:3rem;border-width:.25rem;border-color:var(--palette-color-4);animation:forwards svelte-1fakwj9-intro_animation .5s;padding-bottom:1rem;min-height:100%}#Header.svelte-1fakwj9{text-align:center;font-family:'Rubik';color:var(--palette-color-2);font-weight:bold;font-size:3.25rem;grid-row:1;margin:auto}#Image.svelte-1fakwj9{grid-row:2;grid-column:1;max-width:100%;width:auto;height:auto;margin:auto;padding-bottom:5%;padding-top:5%;border-radius:3rem}#Text.svelte-1fakwj9{grid-row:3;grid-column:1;text-align:center;font-family:'Rubik';color:var(--palette-color-2);font-size:1.7rem;margin:auto}#Button.svelte-1fakwj9{grid-row:4;grid-column:1;height:90%;width:90%;margin:auto;border-radius:2rem;background-color:var(--palette-color-4);font-size:2rem;font-family:'Rubik';transition:.35s;border-style:solid;border-color:var(--palette-color-3)}#Button.svelte-1fakwj9:hover{color:var(--palette-color-2);border-style:solid;border-width:1rem;border-color:var(--palette-color-3);width:70%;cursor:pointer}");
    }
    ...
    function add_css$2(target) {
    	append_styles(target, "svelte-mz7e61", "@keyframes svelte-mz7e61-intro_animation{0%{opacity:0%;transform:translateY(-10rem)}100%{opacity:100%;transform:translateY(0rem)}}h1.svelte-mz7e61{text-align:center;font-family:'Secular One';font-size:5rem;color:var(--palette-color-2);text-shadow:0.5rem 0.5rem black;margin-bottom:7rem;animation:forwards svelte-mz7e61-intro_animation .5s\r\n    }#ProjectGrid.svelte-mz7e61{width:75%;height:fit-content;margin:0 12.5% 50rem 12.5%;display:grid;grid-template-columns:1fr 1fr 1fr;grid-template-rows:max-content max-content max-content;gap:7%}.green.svelte-mz7e61{color:var(--palette-color-4)\r\n    }");
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			h1 = element("h1");
    			h1.innerHTML = `<span class="green svelte-mz7e61">[ </span>P R O J E C T S <span class="green svelte-mz7e61">]</span>`;
    			t3 = space();
    			div = element("div");
    			...
    			attr(h1, "class", "svelte-mz7e61");
    			attr(div, "id", "ProjectGrid");
    			attr(div, "class", "svelte-mz7e61");
    		},
    		m(target, anchor) {
    			insert(target, h1, anchor);
    			insert(target, t3, anchor);
    ...
    function add_css$1(target) {
    	append_styles(target, "svelte-6v6q4j", "@keyframes svelte-6v6q4j-intro_animation{0%{opacity:0%;transform:translateY(-10rem)}100%{opacity:100%;transform:translateY(0rem)}}h1.svelte-6v6q4j{text-align:center;font-family:'Secular One';font-size:5rem;color:var(--palette-color-2);text-shadow:0.5rem 0.5rem black;margin-bottom:7rem;animation:forwards svelte-6v6q4j-intro_animation .5s\r\n    }h2.svelte-6v6q4j{text-align:center;font-family:'Rubik';font-size:3rem;color:var(--palette-color-2);text-shadow:0.5rem 0.5rem black;margin-bottom:5rem}.green.svelte-6v6q4j{color:var(--palette-color-4)\r\n    }#contact_area.svelte-6v6q4j{display:block;width:70%;height:100%;margin:5rem auto;animation:forwards svelte-6v6q4j-intro_animation .5s\r\n    }h3.svelte-6v6q4j{font-size:3rem;text-align:center;color:var(--palette-color-2);font-family:'Rubik'}a.svelte-6v6q4j{color:var(--palette-color-2)}");
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			h1 = element("h1");
    			h1.innerHTML = `<span class="green svelte-6v6q4j">[</span> C O N T A C T <span class="green svelte-6v6q4j">]</span>`;
    			t3 = space();
    			div = element("div");

    			div.innerHTML = `<h2 class="svelte-6v6q4j">Feel free to contact me at any of the following:</h2> 
    <h3 class="svelte-6v6q4j"><span class="green svelte-6v6q4j">EMAIL:</span> evanhecht01@gmail.com</h3> 
    <h3 class="svelte-6v6q4j"><span class="green svelte-6v6q4j">PHONE:</span> (414)-336-8237</h3> 
    <h3 class="svelte-6v6q4j"><span class="green svelte-6v6q4j">LINKEDIN: </span><a href="https://www.linkedin.com/in/hechtevan/" class="svelte-6v6q4j">linkedin.com/in/hechtevan/</a></h3>`;

    			attr(h1, "class", "svelte-6v6q4j");
    			attr(div, "id", "contact_area");
    			attr(div, "class", "svelte-6v6q4j");
    		},
    		m(target, anchor) {
    			insert(target, h1, anchor);
    			insert(target, t3, anchor);
    ...
    function add_css(target) {
    	append_styles(target, "svelte-19u1udt", "@keyframes svelte-19u1udt-appear-from-top{from{opacity:0%;transform:translateY(-5rem)}to{opacity:100%;transform:translateY(0rem)}}@keyframes svelte-19u1udt-appear-from-left{from{opacity:0%;transform:translateX(-10rem)}to{opacity:100%;transform:translateX(0rem)}}#container.svelte-19u1udt{width:100%;position:fixed;z-index:10;transition:.5s}ul.svelte-19u1udt{list-style-type:none;overflow:hidden;text-align:right;height:4rem;line-height:4rem;padding:0.5rem 0 0.5rem 0}li.svelte-19u1udt{display:inline-block;height:100%;padding:0rem 1rem;opacity:0}a.svelte-19u1udt{color:var(--palette-color-2);display:inline-block;font-size:x-large;font-family:'Rubik';text-decoration:none;height:100%;padding:0 1rem;border-radius:1rem;border:1rem;transition:0.5s;opacity:1}a.svelte-19u1udt:hover{background-color:var(--palette-color-4);color:var(--palette-color-1);transform:translateX(-1rem)}img.svelte-19u1udt{display:inline-block;height:100%}#logo.svelte-19u1udt{float:left;padding-left:1rem;animation:svelte-19u1udt-appear-from-left 0.5s 0s forwards}#link_1.svelte-19u1udt{animation:svelte-19u1udt-appear-from-top 0.5s 0s forwards}#link_2.svelte-19u1udt{animation:svelte-19u1udt-appear-from-top 0.5s 0.1s forwards}#link_3.svelte-19u1udt{animation:svelte-19u1udt-appear-from-top 0.5s 0.2s forwards}");
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			div.innerHTML = `<ul class="svelte-19u1udt"><li id="logo" class="svelte-19u1udt"><img src="resources/images/EvanHecht.png" alt="Greeb Games logo" class="svelte-19u1udt"/></li> 
    <li id="link_1" class="svelte-19u1udt"><a id="HomeLink" href="#" class="svelte-19u1udt">HOME</a></li> 
    <li id="link_2" class="svelte-19u1udt"><a id="ProjectsLink" href="#" class="svelte-19u1udt">PROJECTS</a></li> 
    <li id="link_3" class="svelte-19u1udt"><a id="ContactLink" href="#" class="svelte-19u1udt">CONTACT</a></li></ul>`;

    			attr(div, "id", "container");
    			attr(div, "class", "svelte-19u1udt");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    		},
