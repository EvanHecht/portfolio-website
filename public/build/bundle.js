...
var app = (function () {
    ...
    function add_css$5(target) {
    	append_styles(target, "svelte-4ysdhi", "@keyframes svelte-4ysdhi-appear-from-top{from{opacity:0%;transform:translateY(-10rem)}to{opacity:100%;transform:translateY(0rem)}}@keyframes svelte-4ysdhi-appear-from-bottom{from{opacity:0%;transform:translateY(10rem)}to{opacity:100%;transform:translateY(0rem)}}@keyframes svelte-4ysdhi-arrow-animation{0%{opacity:0%}10%{opacity:100%;transform:translateY(0rem)}20%{opacity:100%;transform:translateY(2rem)}30%{transform:translateY(0rem);opacity:100%\r\n        }40%{transform:translateY(2rem);opacity:100%\r\n        }50%{transform:translateY(0rem);opacity:100%\r\n        }60%{transform:translateY(2rem);opacity:100%\r\n        }70%{transform:translateY(0rem);opacity:100%\r\n        }80%{transform:translateY(2rem);opacity:100%\r\n        }90%{transform:translateY(0rem);opacity:100%\r\n        }100%{transform:translateY(2rem);opacity:0%\r\n        }}h1.svelte-4ysdhi{text-align:center;color:silver;font-family:\"Rubik\";font-weight:1;font-size:3.5rem;margin:8rem 0 0 0;opacity:0;animation:svelte-4ysdhi-appear-from-top 1s .5s forwards}h2.svelte-4ysdhi{text-align:center;color:grey;font-family:\"Rubik\";font-weight:1;font-size:2.5rem;margin:0 0 2rem;opacity:0;animation:svelte-4ysdhi-appear-from-bottom 1s 1.5s forwards}#arrow.svelte-4ysdhi{width:2.5%;image-rendering:crisp-edges;margin:3rem 48.5%;opacity:0;animation:svelte-4ysdhi-arrow-animation 5s 2.5s forwards}");
    }
    ...
    function add_css$4(target) {
    	append_styles(target, "svelte-u29zhb", "#container.svelte-u29zhb{display:grid;grid-template-rows:auto auto;grid-template-columns:fit-content(25%) fit-content(75%);background-color:var(--palette-color-3);gap:1rem;padding:1rem;width:80%;margin:0 10% 8rem 10%;border-radius:3rem;opacity:0%;transform:translateX(-10rem);transition:0.75s;box-shadow:0 1.5rem 1rem #000000c0;border-style:outset;border-radius:3rem;border-width:.5rem;border-color:var(--palette-color-4);font-size:100%;overflow:hidden}#header.svelte-u29zhb{grid-row-start:1;grid-row-end:2;grid-column-start:2;grid-column-end:3;min-width:100%;height:100%;overflow:hidden;font-family:\"Secular One\";text-align:center;font-size:4rem;margin:0;color:var(--palette-color-2);font-weight:lighter}#image_area.svelte-u29zhb{grid-row-start:1;grid-row-end:3;grid-column-start:1;grid-column-end:2;width:100%;margin:auto}#text_area.svelte-u29zhb{grid-row-start:2;grid-row-end:3;grid-column-start:2;grid-column-end:3;font-family:\"Rubik\";text-align:left;width:100%;font-size:1.75rem;color:var(--palette-color-2);line-height:3.25rem;margin:0;vertical-align:top;line-height:2.25rem}");
    }
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h1, "class", "svelte-u29zhb");
    			attr(div0, "id", "image_area");
    			attr(div0, "class", "svelte-u29zhb");
    			attr(div1, "id", "text_area");
    			attr(div1, "class", "svelte-u29zhb");
    			attr(div2, "id", "container");
    			attr(div2, "class", "svelte-u29zhb");
    		},
    		m(target, anchor) {
    ...
    function add_css$3(target) {
    	append_styles(target, "svelte-13eulki", "@keyframes svelte-13eulki-intro_animation{0%{opacity:0%;transform:translateY(10rem)}100%{opacity:100%;transform:translateY(0rem)}}#Container.svelte-13eulki{background-color:var(--palette-color-3);height:fit-content;max-height:55rem;margin:0;display:grid;grid-template-columns:auto;grid-template-rows:.25fr 2fr fit-content 1.25fr;border-radius:3rem 3rem;padding:2.5%;box-shadow:0 1.5rem 1rem;border-style:outset;border-radius:3rem;border-width:.25rem;border-color:var(--palette-color-4);animation:forwards svelte-13eulki-intro_animation .5s;padding-bottom:1rem;min-height:100%}#Header.svelte-13eulki{text-align:center;font-family:'Rubik';color:var(--palette-color-2);font-weight:bold;font-size:2rem;grid-row:1;margin:auto}#Image.svelte-13eulki{grid-row:2;grid-column:1;max-width:100%;width:auto;height:auto;margin:auto;padding-bottom:5%;padding-top:5%;border-radius:3rem}#Text.svelte-13eulki{grid-row:3;grid-column:1;text-align:center;font-family:'Rubik';color:var(--palette-color-2);font-size:1.5rem;margin:auto;line-height:2rem}#Button.svelte-13eulki{grid-row:4;grid-column:1;height:90%;width:90%;margin:auto;border-radius:2rem;background-color:var(--palette-color-4);font-size:1.5rem;font-family:'Rubik';transition:.35s;border-style:solid;border-color:var(--palette-color-3)}#Button.svelte-13eulki:hover{color:var(--palette-color-2);border-style:solid;border-color:var(--palette-color-3);width:80%;cursor:pointer}");
    }
    ...
    function add_css$2(target) {
    	append_styles(target, "svelte-19k86", "@keyframes svelte-19k86-intro_animation{0%{opacity:0%;transform:translateY(-10rem)}100%{opacity:100%;transform:translateY(0rem)}}h1.svelte-19k86{text-align:center;font-family:'Secular One';font-size:3.5rem;color:var(--palette-color-2);text-shadow:0.35rem 0.35rem black;margin-bottom:7rem;animation:forwards svelte-19k86-intro_animation .5s\r\n    }#ProjectGrid.svelte-19k86{width:75%;height:fit-content;margin:0 12.5% 50rem 12.5%;display:grid;grid-template-columns:1fr 1fr 1fr;grid-template-rows:max-content max-content max-content;gap:7%}.green.svelte-19k86{color:var(--palette-color-4)\r\n    }");
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			h1 = element("h1");
    			h1.innerHTML = `<span class="green svelte-19k86">[ </span>P R O J E C T S <span class="green svelte-19k86">]</span>`;
    			t3 = space();
    			div = element("div");
    			...
    			attr(h1, "class", "svelte-19k86");
    			attr(div, "id", "ProjectGrid");
    			attr(div, "class", "svelte-19k86");
    		},
    		m(target, anchor) {
    			insert(target, h1, anchor);
    			insert(target, t3, anchor);
    ...
    function add_css$1(target) {
    	append_styles(target, "svelte-vfygq8", "@keyframes svelte-vfygq8-intro_animation{0%{opacity:0%;transform:translateY(-10rem)}100%{opacity:100%;transform:translateY(0rem)}}h1.svelte-vfygq8{text-align:center;font-family:'Secular One';font-size:3.5rem;color:var(--palette-color-2);text-shadow:0.5rem 0.5rem black;margin-bottom:7rem;animation:forwards svelte-vfygq8-intro_animation .5s\r\n    }h2.svelte-vfygq8{text-align:center;font-family:'Rubik';font-size:2rem;color:var(--palette-color-2);text-shadow:0.5rem 0.5rem black;margin-bottom:5rem}.green.svelte-vfygq8{color:var(--palette-color-4)\r\n    }#contact_area.svelte-vfygq8{display:block;width:70%;height:100%;margin:5rem auto;animation:forwards svelte-vfygq8-intro_animation .5s\r\n    }h3.svelte-vfygq8{font-size:2rem;text-align:center;color:var(--palette-color-2);font-family:'Rubik'}a.svelte-vfygq8{color:var(--palette-color-2)}");
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			h1 = element("h1");
    			h1.innerHTML = `<span class="green svelte-vfygq8">[</span> C O N T A C T <span class="green svelte-vfygq8">]</span>`;
    			t3 = space();
    			div = element("div");

    			div.innerHTML = `<h2 class="svelte-vfygq8">Feel free to contact me at any of the following:</h2> 
    <h3 class="svelte-vfygq8"><span class="green svelte-vfygq8">EMAIL:</span> evanhecht01@gmail.com</h3> 
    <h3 class="svelte-vfygq8"><span class="green svelte-vfygq8">PHONE:</span> (414)-336-8237</h3> 
    <h3 class="svelte-vfygq8"><span class="green svelte-vfygq8">LINKEDIN: </span><a href="https://www.linkedin.com/in/hechtevan/" class="svelte-vfygq8">linkedin.com/in/hechtevan/</a></h3>`;

    			attr(h1, "class", "svelte-vfygq8");
    			attr(div, "id", "contact_area");
    			attr(div, "class", "svelte-vfygq8");
    		},
    		m(target, anchor) {
    			insert(target, h1, anchor);
    			insert(target, t3, anchor);
    ...
    function add_css(target) {
    	append_styles(target, "svelte-3hjynm", "@keyframes svelte-3hjynm-appear-from-top{from{opacity:0%;transform:translateY(-5rem)}to{opacity:100%;transform:translateY(0rem)}}@keyframes svelte-3hjynm-appear-from-left{from{opacity:0%;transform:translateX(-10rem)}to{opacity:100%;transform:translateX(0rem)}}#container.svelte-3hjynm{width:100%;position:fixed;z-index:10;transition:.5s;height:fit-content}ul.svelte-3hjynm{list-style-type:none;overflow:hidden;text-align:right;height:4rem;line-height:4rem;padding:0.5rem 0 0.5rem 0;margin:auto}li.svelte-3hjynm{display:inline-block;height:100%;padding:0rem 1rem;opacity:0;margin:auto}a.svelte-3hjynm{color:var(--palette-color-2);display:inline-block;font-size:large;font-family:'Rubik';text-decoration:none;height:100%;padding:0 1rem;border-radius:1rem;border:1rem;transition:0.5s;opacity:1}a.svelte-3hjynm:hover{background-color:var(--palette-color-4);color:var(--palette-color-1);transform:translateX(-1rem)}img.svelte-3hjynm{display:block;max-height:70%;margin-top:7.5%}#logo.svelte-3hjynm{float:left;padding-left:1rem;animation:svelte-3hjynm-appear-from-left 0.5s 0s forwards}#link_1.svelte-3hjynm{animation:svelte-3hjynm-appear-from-top 0.5s 0s forwards}#link_2.svelte-3hjynm{animation:svelte-3hjynm-appear-from-top 0.5s 0.1s forwards}#link_3.svelte-3hjynm{animation:svelte-3hjynm-appear-from-top 0.5s 0.2s forwards}");
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			div.innerHTML = `<ul class="svelte-3hjynm"><li id="logo" class="svelte-3hjynm"><img src="resources/images/EvanHecht.png" alt="Greeb Games logo" class="svelte-3hjynm"/></li> 
    <li id="link_1" class="svelte-3hjynm"><a id="HomeLink" href="#" class="svelte-3hjynm">HOME</a></li> 
    <li id="link_2" class="svelte-3hjynm"><a id="ProjectsLink" href="#" class="svelte-3hjynm">PROJECTS</a></li> 
    <li id="link_3" class="svelte-3hjynm"><a id="ContactLink" href="#" class="svelte-3hjynm">CONTACT</a></li></ul>`;

    			attr(div, "id", "container");
    			attr(div, "class", "svelte-3hjynm");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    		},
